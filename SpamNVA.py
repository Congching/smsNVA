...
class SPAM:
    ...
    def banner(self):
        ...
        title = '\n\n\n---By Nguyn Vit Anh p zai nht h mt tri ---'
        banner = '''\n 
__      ___      _                  _     
\ \    / (_)    | |     /\         | |    
 \ \  / / _  ___| |_   /  \   _ __ | |__  
  \ \/ / | |/ _ \ __| / /\ \ | '_ \| '_ \ 
   \  /  | |  __/ |_ / ____ \| | | | | | |
    ...
    def run(self):
        while True:
            self.banner()
            self.phone = input(self.format_input("NVA",f"NHP SDT  TOOL CA VIT ANH SPAM : "))
            if self.phone != '0937576173':
                if len(self.phone) == 10:
                    break
                print(self.format_print("NVA", "S IN THOI DI <10 S XIN NHP LI !"))
            if self.phone == '0937576173':
                print(self.format_print("NVA", "LÀM N NG SPAM S IN THOI VietAnh!"))
            time.sleep(3)
